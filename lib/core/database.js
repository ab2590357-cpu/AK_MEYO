...
const sessionDefaults = () => enforceAwayPolicy({
  ...
  menuTheme: 'royal', ownerAlerts: true, importantAlerts: true, importantAlertCooldownMinutes: 30, autoCleanup: true, funVisuals: true,
...
const defaults = () => ({
  ...
  activity: [], commandAudit: [], importantAlerts: [], safetyDaily: {}, backups: []
});
