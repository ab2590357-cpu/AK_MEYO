...
export function awayCooldownMs(settings = {}) {
  const minutes = Number(settings.awayCooldownMinutes || settings.autoReplyCooldownMinutes || process.env.AUTO_REPLY_COOLDOWN_MINUTES || process.env.AWAY_COOLDOWN_MINUTES || DEFAULT_AWAY_COOLDOWN_MINUTES);
